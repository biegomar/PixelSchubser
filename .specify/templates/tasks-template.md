...
- [ ] T011a [P] [US1] Domain/Application regression test for changed rule in
...
- [ ] T017a [US1] Verify cross-adapter UX consistency for equivalent operation
      outcomes
- [ ] T017b [US1] Measure and record performance against defined budget
...
- [ ] T019 [P] [US2] Integration test for [user journey] in
      tests/integration/test_[name].py
- [ ] T019a [P] [US2] Domain/Application regression test for changed rule in
      tests/unit/test_[name].py
...
- [ ] T023a [US2] Verify cross-adapter UX consistency for equivalent operation
      outcomes
- [ ] T023b [US2] Measure and record performance against defined budget
...
- [ ] T025 [P] [US3] Integration test for [user journey] in
      tests/integration/test_[name].py
- [ ] T025a [P] [US3] Domain/Application regression test for changed rule in
      tests/unit/test_[name].py
...
- [ ] T028a [US3] Verify cross-adapter UX consistency for equivalent operation
      outcomes
- [ ] T028b [US3] Measure and record performance against defined budget
