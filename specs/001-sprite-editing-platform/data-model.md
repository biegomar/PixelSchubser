...
- **Fields**: projectId, name, platformProfile, sprites, animations,
  globalColors, metadata, activeSpriteIndex, currentSelection, undoState.
...
- **Validation**: Pen grid dimensions must match the platform profile; pen
  values must be valid logical pens.
...
- **Validation**: Coordinates must define a valid rectangle within sprite
  bounds.
